...
#define CONSTANT_BVH_CONSTRUCTION_V1 9
#define CONSTANT_BVH_CONSTRUCTION_V2 10
#define BINNED_BVH_CONSTRUCTION 11

#define TARGET_BVH_ALGORITHM BINNED_BVH_CONSTRUCTION
